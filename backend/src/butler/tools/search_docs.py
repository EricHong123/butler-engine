...
def _get_mock_documents() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "date": "2020-03-15",
            "tags": "信托, 教育, 张明, 张悦",
            "excerpt": "Settlor: Zhang Wei. Beneficiaries: Zhang Ming, Zhang Yue. Purpose: education expenses including tuition, living, and extracurricular.",
            "expiry_date": None,
        },
        {
            ...
            "date": "2018-06-01",
            "tags": "保险, 寿险, 友邦, 美元",
            "excerpt": "Policy type: Universal Life. Insured: Zhang Wei. Sum assured: USD 5,000,000. Annual premium: USD 50,000.",
            "expiry_date": None,
        },
        {
